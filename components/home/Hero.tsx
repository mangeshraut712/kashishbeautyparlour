 ...
 * Hero Component
 *
 * Displays the main hero section of the homepage with badge, title, description,
 * statistics, and call-to-action buttons. Includes an image and floating cards.
 *
 * @returns {JSX.Element} The hero section JSX
 */
'use client'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-gray-900 leading-tight"
              dangerouslySetInnerHTML={{ __html: heroContent.title.replace('Artistry', '<span class="text-primary">Artistry</span>') }}
            ></h1>
          ...
          <div className="relative">
            ...
            {floatingCards.map((card, index) => (
              <div key={index} className={`absolute ${index === 0 ? '-bottom-4 -left-4' : 'top-4 -right-4'} bg-white p-4 rounded-xl shadow-lg z-20 hidden md:block`}>
