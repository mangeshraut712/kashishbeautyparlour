export const BUSINESS_INFO = {
  ...
  address: {
    ...
    area: 'Thergaon, Pimpri-Chinchwad',
    city: 'Pune',
    state: 'Maharashtra',
    pincode: '411033',
...
// Centralized business statistics - use these everywhere for consistency
export const BUSINESS_STATS = {
  yearsOfExperience: '12+',
  yearsLabel: 'Years of Excellence',
  happyCustomers: '10,000+',
  customersLabel: 'Happy Clients',
  happyBrides: '1,000+',
  bridesLabel: 'Happy Brides',
  totalServices: '50+',
